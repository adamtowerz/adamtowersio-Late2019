    ...
    <main>
      <div className="center-col">
        ...
        <p>
          ...
          studying computer science and entrepreneurship. Over the last 3 years
          of college I’ve founded (and failed at){" "}
          <Popover
            popoverContent={
              <div>
                <p>
                  ...
                  , I founded a company with a group of students (some
                  undergrad, some grad) focused on providing employment
                  compensation analytics so people could be confident they were
                  being paid what they deserved.
                </p>
                <p>
                  ...
                  , and took first in our course cohort when presenting at
                  Pioneer Square Labs, and ranked third in the Dempsey startup
                  competition. We spun out of the class and were focused on
                  building the product and executing on our go-to-market plan
                  when life got in the way and slowly many cofounders had to
                  step away for other obligations.
                </p>
                <p>
            ...
            popoverContent={
              <div>
                <p>
                  ...
                  , a human-computer interaction (HCI) class taught using
                  Android. The first time I TA'd this course was the first time
                  it was ever taught. I had to learn the content right before I
                  taught it which was stressful but rewarding.
                </p>
                <p>
                  While head TA, I managed a group of 4 other TAs and worked on
                  technical course infrastructure including our automated
                  testing framework for assignments. I was also a part of
                  discussing the pedagogy of the class, and iterating as we
                  received feedback.
                </p>
              </div>
            }
          ...
          <Popover
            popoverContent={
              <div>
                ...
                <p>
                  It also provided me a living community my freshman year where
                  I met many of my college friends.
                </p>
              </div>
            }
          >
          ...
          . My time at university is going by quickly, but I strongly believe I
          am making the most of it.
        </p>

        <p>
          My goal for my early career is to learn as much as I can by working on
          interesting problems with interesting people, and I've been working
          hard to achieve that. After my freshman year I worked on exploring{" "}
          <Popover
            popoverContent={
              <div>
                <p>
                ...
                <ul>
                  <li>
                    ...
                    closely with data analysts to understand and categorize
                    credit debt repayment patterns and build the tooling to
                    visualize and modify those patterns in order to drive
                    insights. Improved the granularity of the analysis by a
                    factor of 10, and set the stage for future work by creating
                    more agile tooling.
                  </li>
                  <li>
                    Blockchain Executive Papers: Coordinated closely with
                    internal teams to prepare 3 executive papers on blockchain
                    and its current market state (competitive intelligence) for
                    Intuit executives.
                  </li>
                </ul>
              </div>
          ...
          <Popover
            popoverContent={
              <div>
                <p>
                  <b>
                    Technical Program Management Intern during the summer of
                    2019
                  </b>
                </p>
                <p>
                ...
                <ul>
                  <li>
                    ...
                    solution to support legal compliance for changing
                    legislation in Europe. Designed to meet the needs of
                    multiple stakeholders across leadership and partner
                    relations.
                  </li>
                  <li>
                    Collaborated with the support organization to drive process
                    improvements to a feedback pipeline. Expanded it from just
                    Googler reports to external users as well, leading to new
          ...
          <Popover
            popoverContent={
              <div>
                ...
                <p>
                  Working here has validated my hypothesis that I would
                  thoroughly enjoy working at a small and fast paced
                  environment. I have an unparalleled amout of ownership over my
                  work, and am shipping new things frequently.
                </p>
              </div>
            }
          >
